...
// We call an arrow function with onclick because if we call the the props function directly we will call the
...
// ReactDOM.render(<User name='Vinayak' age={26} />, document.getElementById('app'));
